...
import { MongoService, Move } from './mongo.service';

// --- TYPE DEFINITIONS ---
export type Tile = { letter: string; value: number };
export type Player = { id: number; name: string; score: number; rack: Tile[] };
...
export type Placement = { x: number; y: number; tile: Tile, isBlank?: boolean };
